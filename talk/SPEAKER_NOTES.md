...
| 22 | What's behind the scan | 0:38–0:39 | credibility *(cuttable)* |
| 23 | **Hardened, live** | 0:39–0:41 | **demo:** same attack blocked |
| 24 | Break the graph | 0:41–0:43 | the four controls |
| 25 | Close | 0:43–0:44 | thesis restated |
| 26 | Resources & disclaimer | 0:44–0:45 | links, Q&A |
...
## Two beats to nail
- **Slide 18 reveal:** "I didn't tell ZIRAN this was dangerous — its built-in patterns did. I gave it a graph; it gave me the exit."
...
**Timing guardrails:** if running long, cut slide 22 (credibility) first, then slide 7. **Never cut the reveal (17–18) or the exploit (20, 23).**
